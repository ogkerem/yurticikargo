...
Class yurticiKargo {
    ...
    public function __construct(array $attributes = array()) {
        ...
        if (isset($attributes['testMode']) && $attributes['testMode']==true){
            self::$url = 'https://testws.yurticikargo.com/KOPSWebServices/WsReportWithReferenceServices?wsdl';
    ...
    public function queryShipment($keys,$keyType,$addHistoricalData=true,$onlyTracking=true) {
        ...
        $xml = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:ship="http://yurticikargo.com.tr/sswIntegrationServices">
           <soapenv:Header/>
           <soapenv:Body>
              <ship:queryShipment>
